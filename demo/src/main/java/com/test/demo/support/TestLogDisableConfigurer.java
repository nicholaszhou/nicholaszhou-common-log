...
//
//        commonLogHttpProperties = new CommonLogProperties.HttpPathProperties();
//        commonLogHttpProperties.setPath("/do*");
//        commonLogHttpProperties.setMethods(Collections.singleton(HttpMethod.POST));
//
//        logProperties = new CommonLogProperties.LogProperties();
//        logProperties.setDisableReq(true);
//        logProperties.setDisableResp(true);
//
//        commonLogHttpProperties.setLog(logProperties);
